...
public class showqid extends HttpServlet {
...
PreparedStatement ps=con.prepareStatement("select qans.qid,qans.qa,answer.qa,answer.sub from qans,answer where qans.qid=? and qans.qid=answer.qid");
...
con.close();
            ...
            Logger.getLogger(showqid.class.getName()).log(Level.SEVERE, null, ex);
